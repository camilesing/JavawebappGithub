...
<script type="text/javascript" src="${ctx}/resources/js/bosapp/reportview_retail_101.js" ></script>

   <div data-role="page" id="reportview_table" project_path="${ctx}"> 
   		<div data-role="header" data-theme="b">
        	<a href="reportview" data-ajax="false">返回</a>
   			<h1 align="center"> 应收款分析 </h1>
   		...
   		<div data-role="content" data-theme="c" id="reportview_table_div_id" style="margin: 0;border: 0;padding: 0">
			<table width=100%>
			    <tr>
			    <td><a href="#" id="refreshCus" class="ui-btn ui-icon-refresh">加载经销商</a></td>
			    <td>
