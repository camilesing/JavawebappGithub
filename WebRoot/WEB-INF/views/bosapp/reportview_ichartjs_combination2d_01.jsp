...
<script type="text/javascript" src="${ctx}/resources/js/bosapp/reportview_ichartjs_combination2d_01.js" ></script>
   ...
   <div data-role="page" id="reportview_ichartjs" project_path="${ctx}"> 
   		...
   		<div data-role="content" data-theme="b" style="margin: 0;border: 0;padding: 0;overflow:scroll">
			...
			<a href="#" id="refreshIchartjs" class="ui-btn ui-icon-refresh">生成Ichartjs 图表</a>
   			<div id='ichartjs_content' style="margin: 0;border: 0;padding: 0;height: 400px" ></div>
   		</div> <!--  end content -->
